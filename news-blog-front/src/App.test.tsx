...
import {LOCATION_TEST} from "./constants/routes";
...
test('Login', async () => {
    ...
    test('Add article', async () => {
       ...
       //
        ...
        await sleep(10_000);
        const url = page?.url();
        expect(url).toBe(`${LOCATION_TEST}/editor`);
    }, 30_000);
    ...
    test('change profile', async () => {
      ...
      //  await page?.goto(`${LOCATION_TEST}/article/10`);
        ...
        const url = page?.url();
        expect(url).toBe(`${LOCATION_TEST}/article/10`);
    }, 30_000);
    ...
    test('Export to Excel test', async () => {
        ...
        await sleep(1_000);
        await page?.goto(`${LOCATION_TEST}/channel/statistics/articles`);
        await sleep(10_000);
